...
-- ----------------------------
-- Table structure for `ls_wx_about`
-- ----------------------------
DROP TABLE IF EXISTS `ls_wx_about`;
CREATE TABLE `ls_wx_about` (
...
-- ----------------------------
-- Records of ls_wx_about
-- ----------------------------
INSERT INTO `ls_wx_about` VALUES ('wxApp', '关于我们', '<p>南京维光照明</p><p><br></p><p><span class=\"ql-size-small\" style=\"color: rgb(68, 68, 68);\">   </span></p><p><br></p><p><span style=\"color: rgb(68, 68, 68);\"></span></p><p><br></p><p><span class=\"ql-size-small\" style=\"color: rgb(68, 68, 68);\"> </span></p>');
INSERT INTO `ls_wx_about` VALUES ('wxDeveloper', '关于开发者', '<p class=\"ql-align-center\"><span class=\"ql-size-small\"></span></p>');

-- ----------------------------
-- Table structure for `ls_wx_admin_user`
-- ----------------------------
DROP TABLE IF EXISTS `ls_wx_admin_user`;
CREATE TABLE `ls_wx_admin_user` (
...
-- ----------------------------
-- Records of ls_wx_admin_user
-- ----------------------------
INSERT INTO `ls_wx_admin_user` VALUES ('1', 'admin', '1234qwer');

-- ----------------------------
-- Table structure for `ls_wx_article_comment`
-- ----------------------------
DROP TABLE IF EXISTS `ls_wx_article_comment`;
CREATE TABLE `ls_wx_article_comment` (
...
-- ----------------------------
-- Records of ls_wx_article_comment
-- ----------------------------
INSERT INTO `ls_wx_article_comment` VALUES ('22', '28', '30', '测试', '2018-11-01 23:12:38');
INSERT INTO `ls_wx_article_comment` VALUES ('23', '30', '30', '?????', '2018-11-10 14:11:48');

-- ----------------------------
-- Table structure for `ls_wx_article_kind_list`
-- ----------------------------
DROP TABLE IF EXISTS `ls_wx_article_kind_list`;
CREATE TABLE `ls_wx_article_kind_list` (
...
-- ----------------------------
-- Records of ls_wx_article_kind_list
-- ----------------------------
INSERT INTO `ls_wx_article_kind_list` VALUES ('1', '餐饮');
INSERT INTO `ls_wx_article_kind_list` VALUES ('2', '商业');
INSERT INTO `ls_wx_article_kind_list` VALUES ('3', '户外');

-- ----------------------------
-- Table structure for `ls_wx_article_list`
-- ----------------------------
DROP TABLE IF EXISTS `ls_wx_article_list`;
CREATE TABLE `ls_wx_article_list` (
...
-- ----------------------------
-- Records of ls_wx_daily
-- ----------------------------
-- INSERT INTO `ls_wx_daily` VALUES ('14', 'https://server.raydom.wang/static/uploadImg/hjamda5sv4a.jpg', '累的时候，再坚持一下', 'Raydom', '13', '11', '2018', '2018-11-14 22:34:35', '13', '1', '2018-11-14 22:34:35', '154212480');
-- INSERT INTO `ls_wx_daily` VALUES ('15', 'https://server.raydom.wang//static/uploadImg/cwzjbmv5r2.jpg', '要敢于争取', '不抱怨的世界', '12', '11', '2018', '2018-11-15 17:05:14', '4', '1', '2018-11-15 17:05:14', '154203840');

-- ----------------------------
-- Table structure for `ls_wx_user`
-- ----------------------------
DROP TABLE IF EXISTS `ls_wx_user`;
CREATE TABLE `ls_wx_user` (
  `id` int(6) NOT NULL AUTO_INCREMENT,
...
-- ----------------------------
-- Records of ls_wx_user
-- ----------------------------
-- INSERT INTO `ls_wx_user` VALUES ('30', 'Raydooom', '1', 'https://wx.qlogo.cn/mmopen/vi_32/DYAIOgq83eqE7UMLOYODjHTIpdpibgYNGCQnF7FsAicatibNR3kz5dWuGNicVaagg6c5nBaxrLtZkr5MSGmOFcMQnw/132', '', '', '2018-11-01 19:01:56', 'otvsK0cR45_mL-BKResOj9p2JtGc', '中国', '29,30,28', '30,28');
-- INSERT INTO `ls_wx_user` VALUES ('31', 'Magenta', '1', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTKbyQhBrQjwKtkK20TBKLLeHdCC3fHLJn4p52ydMH2l1EbTqqFkKCttZTpXrT9JibLxRmcicIad8veg/132', '河南', '郑州', '2018-11-01 19:04:26', 'otvsK0ZqDYwJIxbHiSBBYFf8RWO0', '中国', '', '');
-- INSERT INTO `ls_wx_user` VALUES ('32', '花荣', '0', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTIcpwzXOIMNqc3bzJTyqInEV6oKib3zHsOQFEf2R6NbLpMuNLTDomWOHsVicyEpThua9cewUgzwfkvQ/132', '', '', '2018-11-02 15:59:17', 'otvsK0b-ATMmSHEMEE9sbaQ44sE0', '', '', '');
-- INSERT INTO `ls_wx_user` VALUES ('33', '李应', '0', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJGrDY3cRGPxOU4grjqdnKKYTGibNaLEIKzFHYMEX0r0Yj8SkViaTtUE0UXEJibLypyGNRuSTqCiaGLgw/132', '', '', '2018-11-02 16:51:41', 'otvsK0WKuKOJB-6LbiOdXtM6SD0Q', '', '28', '');
-- INSERT INTO `ls_wx_user` VALUES ('34', '小悦悦', '0', '', '', '', '2018-11-03 15:55:24', 'otvsK0X5H1twdx3PXbFyKQqVVuQ8', '', '', '');
-- INSERT INTO `ls_wx_user` VALUES ('35', '鲁智深', '0', 'https://wx.qlogo.cn/mmopen/vi_32/Q0j4TwGTfTJ0OUJicXE9EiccqmMGbgC4I1aiaN9qfXegI0frhvVZicnPztCjQQz7icEWtMYyG7VicAvQ6zeHZJy5fNfQ/132', '', '', '2018-11-03 16:27:03', 'otvsK0cy5W7Hw5YibgANqXg-8Dt8', '', '', '');
-- INSERT INTO `ls_wx_user` VALUES ('36', '方群', '2', 'https://wx.qlogo.cn/mmopen/vi_32/LWicoUend7QPKEWiaJqdPyuBIibeLVTBvicicMfK8dFoJUDaRxA18ibLrNPnuHrXTLmOkTvozJ8mMyTnlLL2qVezUSjg/132', 'Hunan', 'Shaoyang', '2018-11-13 19:50:02', 'otvsK0aq1ftzjIHwQmS9y33RAG_I', 'China', '', '');
